<x-layout bodyClass="g-sidenav-show  bg-gray-200">
    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
        <!-- Navbar -->
        <x-navbars.navs.auth titlePage="Edit Book"></x-navbars.navs.auth>
        <!-- End Navbar -->
                            ...
                            <div class="table-responsive p-0">
                                <form method="POST" action="{{ route('admin.books.update', $book->id) }}"
                                    ...
                                    <div class="d-flex flex-column justify-content-center">
                                        <img style="width: 25%; margin: 5px;" src="{{ Storage::url($book->image) }}"/>
                                    ...
                                    <div class="d-flex flex-column justify-content-center">
                                        <select
                                            style="border-radius: 5px; border: 1px solid lightgray; margin: 10px"
                                            id="author_id" name="author_id[]" multiple="multiple">
                                    ...
                                    <div class="d-flex flex-column justify-content-center">
                                        <select
                                            style="border-radius: 5px; border: 1px solid lightgray; margin: 10px"
                                            id="genre_id" name="genre_id[]" multiple="multiple">
                                    ...
                                    <textarea
                                        style="border-radius: 5px; border: 1px solid lightgray; margin: 10px"
                                        name="summary" id="summary" cols="4"
