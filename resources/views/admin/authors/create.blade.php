<x-layout bodyClass="g-sidenav-show  bg-gray-200">
    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
        <!-- Navbar -->
        <x-navbars.navs.auth titlePage="Create Author"></x-navbars.navs.auth>
        <!-- End Navbar -->
                        ...
                        <div class="card-body px-0 pb-2">
                            <div class="table-responsive p-0">
                                <form method="POST" action="{{ route('admin.authors.store') }}"
                                    ...
                                    @endif
                                    <label for="name" class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7
                                         ps-2">
                                        NAME
                                    </label>
